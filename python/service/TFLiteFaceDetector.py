...
class UltraLightFaceDetecion():
    ...
    def inference(self, img):
        ...
        # print('텐서',time.perf_counter() - start_time)
...
if __name__ == '__main__':
    ...
    fd = UltraLightFaceDetecion("models/RFB-320.tflite",
                                conf_threshold=0.88)
